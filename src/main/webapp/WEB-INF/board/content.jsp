...
<body class="hold-transition skin-blue sidebar-mini layout-boxed">
         ...
         <section class="content container-fluid">
            ...
            <div class="col-lg-12">
                  ...
                  <div class="box-header" align="center">
                     <b style="font-size:30px;">TITLE : ${article.title}</b>
                  </div>
                  ...
                  <br>
				 <%-- 
                  <div class="box-footer" style="padding-top:2%;">
                     <div class="member-block" align="right" >
                         <a href="#" style="text-transform: none;">${article.memberId}</a>
   ...
   <script id="replyTemplate" type="text/x-handlebars-template">
    {{#each.}}
    <div class="post replyDiv" data-replyNo={{replyNo}}><br>
        <div class="user-block">
		<%--댓글 내용--%>
        <div class="oldReplyContent" style="float:left">{{{escape replyContent}}}</div>
            <%--댓글 작성자 프로필사진
            <img class="img-circle img-bordered-sm" src="<c:url value='/dist/img/user1-128x128.jpg'/>" alt="user image">--%>
            <%--댓글 작성자--%>
            <span class="username" style="float:right; text-transform: none;">
                <%--작성자 이름--%>
                <a href="#" style="float:left; text-transform: none;">{{replyWriter}}&emsp;</a>
            ...
            <%--댓글 작성일자--%>
            <span class="description" style="float:left">{{prettifyDate regDate}}</span>&emsp;
			</span>
        </div><br>
