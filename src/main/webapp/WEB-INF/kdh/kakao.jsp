...
<c:if test="${empty login }">
	...
	<a href="https://kauth.kakao.com/oauth/authorize?client_id=fd4f87b0a1c6e0be3ef4cd9b8a05b285&redirect_uri=http://localhost:8080/kakaoLogin&response_type=code">
