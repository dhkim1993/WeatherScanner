					...
					<div class="box box-primary">
							...
							<div class="text-center">
								<ul class="pagination">
									...
									<c:forEach var="idx" begin="${pageCreator.beginPage}" end="${pageCreator.endPage}">
										...
										<a href="<c:url value='/mypage/myWrite${pageCreator.makeSearchURI(idx)}'/>">${idx}</a></li>
									</c:forEach>
						...
						<div class="box-footer" >
							<div class="col-sm-2"></div>
								<form role="form" class="form-inline" style="align:center;">
...
<script type="text/javascript">
	...
	$(document).ready(function() {		
		...
		$("#searchBtn").on("click", function(){
			self.location ="/mypage/myWrite${pageCreator.makePageURI(1)}"
